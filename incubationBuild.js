/* incubationBuild.js — pure builder that turns raw CSV rows into the three
 * insert payloads (user_profile, company_profile, incubated_startups) + match
 * pairs. Shared by the browser (window.IncubationBuild) and Node tests.
 */
(function (root, factory) {
  const CSVKit = (typeof module === "object" && module.exports) ? require("./csv.js") : root.CSVKit;
  const api = factory(CSVKit);
  if (typeof module === "object" && module.exports) module.exports = api;
  root.IncubationBuild = api;
})(typeof self !== "undefined" ? self : this, function (CSVKit) {
  "use strict";

  // Build one normalized row (3 payloads + match info) from a raw CSV row.
  function buildRow(row, IMP, today) {
  ...
  function buildRows(rawRows, IMP, today) {
